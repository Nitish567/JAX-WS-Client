 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://soap.nitish.com/", wsdlLocation = "http://localhost:9999/ws/customer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICEIMPLSERVICE_QNAME = new QName("http://soap.nitish.com/", "CustomerServiceImplService");
    ...
    public CustomerInterface getCustomerServiceImplPort() {
        return super.getPort(new QName("http://soap.nitish.com/", "CustomerServiceImplPort"), CustomerInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "CustomerServiceImplPort")
    public CustomerInterface getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.nitish.com/", "CustomerServiceImplPort"), CustomerInterface.class, features);
    }
